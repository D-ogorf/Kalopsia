...
public class mCh_Mov : MonoBehaviour
{
    ...
    public float curStaminaRegenTime;
    ...
    {
        this._isGrounded = Physics2D.BoxCast(this.transform.position, this.transform.localScale, this.transform.localEulerAngles.z, -transform.up, this.transform.localScale.y / 2 + .05f, LayerMask.GetMask("Platform"));
    ...
    private void DashHandler()
    {
        ...
        if(this._wantDash && this._canDash) Dash();
    }
